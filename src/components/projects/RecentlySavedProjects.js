...
class RecentlySavedProjects extends Component {
  constructor(props){
    super();
    this.state = {
      search: ''
  ...
  render() { 
    ...
    const recentlySavedSortedProjects = this.props ? this.props.projects.projects.sort(function(a,b){
        ...
        {/* <input type="text"
          ...
          <table id="table-js" >
            ...
            <tbody>
              ...
              {recentlySavedSortedProjects.map(row => (
              // console.log("row", row),
